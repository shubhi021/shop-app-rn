...
export default function CheckoutScreen({navigation}: any) {
  ...
  const [paymentMethod, setPaymentMethod] = useState<
    'klarna' | 'sofort' | 'sepa' | 'applePay' | 'card'
  >('klarna');
  ...
  const validateForm = (): boolean => {
    ...
    if (!validateGermanPLZ(zipCode)) {
      setZipCodeError('Gültige 5-stellige PLZ eingeben (z.B. 10115).');
      isValid = false;
    } else {
  ...
  const executeOrder = async () => {
    if (!reduxUser?.uid) {
      Toast.show({
        ...
        text2: 'Bitte melden Sie sich an.',
      });
      return;
    }
  ...
  const PAYMENT_OPTIONS = [
    ...
    },
    {
      id: 'sofort',
      label: t('sofortBank'),
      sub: 'Direktes Online-Banking mit PIN/TAN',
    ...
    },
    {
      id: 'sepa',
      label: t('sepaDebit'),
      sub: 'Bequem per IBAN abbuchen lassen',
    ...
    },
    {
      id: 'applePay',
      label: t('applePay'),
      sub: 'Schnell & sicher mit Touch/Face ID',
              ...
              <TouchableOpacity
                ...
                <View
                  ...
                  {idx < currentStep ? (
                    ...
                    <Text style={[styles.stepNum, {fontFamily: fonts.bold}]}>
                      {idx + 1}
                    </Text>
                  )}
                </View>
                    ...
                    styles.stepLabel,
                    {
                      color:
                        idx === currentStep
                          ...
                          : colors.textTertiary,
                      fontFamily:
                        idx === currentStep ? fonts.bold : fonts.regular,
                    },
                  ]}>
                  {step}
                </Text>
          ...
          <View
            ...
            <View style={styles.summaryRow}>
              ...
              <Text
                style={[
                  styles.summaryValue,
                  {color: shippingFee === 0 ? '#16A34A' : colors.text},
                ]}>
