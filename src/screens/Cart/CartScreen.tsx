...
export default function CartScreen({navigation}: any) {
  ...
  const shippingFee =
    subtotal >= freeShippingThreshold || subtotal === 0 ? 0 : 4.99;
  ...
  const handleApplyPromo = () => {
    ...
    if (found) {
      ...
      Toast.show({
        type: 'success',
        text1: `Promo Applied! ${found.label}`,
        text2: `Code "${code}" activated.`,
      });
    } else {
  ...
  const handleSaveForLater = (item: any) => {
    ...
    Toast.show({
      ...
      text2: `${item.product.title.substring(0, 22)}... moved to Wishlist.`,
    });
  };
    ...
    <SafeAreaView
      ...
      <View
        ...
        <View
          ...
          <Text style={[styles.itemCountText, {fontFamily: fonts.bold}]}>
            {items.length}
          </Text>
        </View>
      </View>
            ...
            {subtotal < freeShippingThreshold ? (
              ...
              <View
                ...
                <Text
                  style={[
                    styles.shippingBannerText,
                    {color: '#16A34A', fontFamily: fonts.bold},
                  ]}>
                ...
                <>
                  <View
                    ...
                    <TouchableOpacity
                      ...
                      activeOpacity={0.8}>
                      <Text
                        style={[styles.applyBtnText, {fontFamily: fonts.bold}]}>
                        Apply
                      </Text>
                    </TouchableOpacity>
                  </View>
                  {promoError && (
                    <Text
                      style={[
                        styles.promoError,
                        {color: '#EF4444', fontFamily: fonts.regular},
                      ]}>
                      {promoError}
                    </Text>
                  )}
              ...
              {isGoGreenShipping && (
                <View style={styles.summaryRow}>
                  ...
                  <Text
                    style={[
                      styles.summaryValue,
                      {color: '#059669', fontFamily: fonts.semiBold},
                    ]}>
              ...
              {appliedPromo && (
                <View style={styles.summaryRow}>
                  ...
                  <Text
                    style={[
                      styles.summaryValue,
                      {color: '#16A34A', fontFamily: fonts.semiBold},
                    ]}>
